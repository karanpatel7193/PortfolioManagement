...
// 		this.minMeasuredChildWidth = 0 ;
// 		this.minMeasuredChildHeight = 0;
// 	}
...
// 	public scrollInto(item: any, alignToBeginning: boolean = true, additionalOffset: number = 0, animationMilliseconds: number = 0, animationCompletedCallback: () => void): void {
...
// 	public scrollToIndex(index: number, alignToBeginning: boolean = true, additionalOffset: number = 0, animationMilliseconds: number = 0, animationCompletedCallback: () => void ): void {
...
// 	protected scrollToIndex_internal(index: number, alignToBeginning: boolean = true, additionalOffset: number = 0, animationMilliseconds: number = 0, animationCompletedCallback: () => void): void {
...
// 	// public scrollToPosition(scrollPosition: number, animationMilliseconds: number = 0, animationCompletedCallback: () => void): void {
